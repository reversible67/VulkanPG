...
protected:
	...
	uint32_t computeTimingFrameCounter = 0;
...
//
	...
	void setupWindow();
#endif
	void getBuffer(void *data, vks::Buffer &buffer, VkDeviceSize size);
	void updateBuffer(vks::Buffer &buffer, VkDeviceSize size, void *data);
	void createBuffer(vks::Buffer &buffer, VkDeviceSize size, VkBufferUsageFlags usageFlags, VkMemoryPropertyFlags memoryPropertyFlags, void *data = nullptr);
	...
	virtual void buildComputeCommandBuffers();
